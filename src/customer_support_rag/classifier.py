...
CLASSIFICATION_SYSTEM_PROMPT = """You are a Celonis support engineer classifying incoming tickets.
...
{"issue_type": "INCIDENT|QUESTION|SERVICE_REQUEST", "confidence": 0.0-1.0, "reasoning": "..."}"""
